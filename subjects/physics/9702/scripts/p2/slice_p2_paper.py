#!/usr/bin/env python3
"""Cambridge Physics 9702 Paper 2 Unified Theory Dual Parser.
...
def is_barcode_span(txt: str, bbox: tuple[float, float, float, float]) -> bool:
    ...
    # Real barcodes are located in outer margins, headers, or footers
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Unified Cambridge Physics 9702 Paper 2 Dual Parser")
    ...
    if args.qp and args.ms and args.dir:
        ...
        print("Usage: slice_p2_paper.py --qp <qp_pdf> --ms <ms_pdf> --dir <paper_dir>")
